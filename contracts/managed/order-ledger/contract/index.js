  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      recordOrder: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(orderId_0).concat(_descriptor_0.toValue(itemHash_0).concat(_descriptor_0.toValue(buyer_0).concat(_descriptor_2.toValue(amount_0)))),
