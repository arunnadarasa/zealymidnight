...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  },
  {
    term: "Midnight",
    tag: "Chain",
    analogy: "The cypher floor: the move is recorded, in order, and the local stack can prove it happened.",
    def: "Midnight Local Undeployed — Compact contracts, a proof server, a node, and a GraphQL indexer where StreetRail settles mUSDC and logs rights.",
    related: ["Proofs", "Indexer", "mUSDC"],
  },
  {
    term: "AP2",
    tag: "Agents",
  ...
  },
  {
    ...
    related: ["Midnight", "Receipt"],
  },
  {
    term: "Compact",
    tag: "Chain",
    analogy: "The choreography score the crew actually dances — not just a flyer.",
    def: "Midnight's smart-contract language. StreetRail's MoveRegistry, MandateVault, and mUSDC contracts are Compact programs.",
    related: ["Midnight", "Move Registry"],
  },
  {
    term: "Gas",
    tag: "Chain",
    analogy: "The door fee for stepping on the floor.",
    def: "On many chains this is a separate fee token. On Undeployed demos the heavy cost is proving the Compact call, then submitting it to the local node.",
    related: ["Proofs", "Midnight"],
  },
  {
    term: "GX",
    tag: "Modes",
  ...
  },
  {
    ...
    def: "Human-to-human: the familiar storefront — browse, add to cart, pay in experimental mUSDC.",
    related: ["GX", "H2A"],
  },
  {
    term: "H2A",
  ...
  },
  {
    term: "Indexer",
    tag: "Chain",
    analogy: "The scorekeeper posting each round where everyone can check it.",
    def: "The local Midnight GraphQL API that indexes blocks and transactions — StreetRail's receipt surface instead of a public EVM explorer.",
    related: ["Receipt", "Midnight"],
  },
  {
    term: "Lace",
    tag: "Wallet",
    analogy: "Your dance card at the door — flash it, you're in.",
    def: "The Midnight browser wallet. Connect Lace for an mn_addr… session used by shop, moves, and A2H payouts.",
    related: ["Wallet"],
  },
  {
    term: "Mandate",
  ...
  },
  {
    ...
    def: "The Compact contract where choreography fingerprints (CIDs) are logged so credit travels with the move.",
  ...
  },
  {
    term: "mUSDC",
    tag: "Money",
    analogy: "The house currency for this Undeployed jam — demo dollars that settle on Midnight.",
    def: "StreetRail's experimental Midnight USDC mimic for local Undeployed rails. Amounts are scaled so the faucet and proof server can keep up.",
    related: ["Stablecoin", "Proofs"],
  },
  {
    term: "Nanopayment",
    tag: "Money",
    analogy: "A tip jar that only gets counted once it's worth the walk to the bank.",
    def: "Tiny per-action charges kept in an off-chain tally and batched to Midnight once they cross a threshold.",
    related: ["x402", "A2A", "mUSDC"],
  },
  {
    term: "Proofs",
    tag: "Chain",
    analogy: "Warming up before you hit the floor — the move isn't posted until the body is ready.",
    def: "Zero-knowledge proofs built by the local proof server for Compact transactions. Cold first proofs can take minutes; run one Midnight write at a time.",
    related: ["Midnight", "Gas"],
  },
  {
    term: "Receipt",
    tag: "Chain",
    analogy: "The clip of the round — proof it happened, timestamped.",
    def: "On-chain proof a payment or registry log went through, viewable on the local Midnight indexer.",
    related: ["Indexer", "Move Registry"],
  },
  {
    term: "Stablecoin",
    tag: "Money",
    analogy: "Prize money that's still the same amount when you get home.",
    def: "A token pegged to a real currency. On this Undeployed build, settlements use experimental mUSDC.",
    related: ["mUSDC"],
  },
  {
    term: "Treasury",
    tag: "Wallet",
    analogy: "The crew's shared pot for faucet top-ups and agent payouts.",
    def: "StreetRail's genesis / server-append wallet that funds Undeployed mUSDC transfers and registry writes for agent rails.",
    related: ["mUSDC", "A2H"],
  },
  {
    term: "Wallet",
    ...
    def: "The account that holds your session identity and receives payouts — on Undeployed, typically a Lace mn_addr… address.",
    related: ["Lace", "Treasury"],
  },
  {
    term: "x402",
    tag: "Agents",
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="Search a term — x402, mandate, mUSDC…"
